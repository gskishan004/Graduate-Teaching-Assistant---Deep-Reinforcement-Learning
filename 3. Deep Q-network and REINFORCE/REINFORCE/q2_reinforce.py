...
plt.plot(test_rewards, label='Test Reward', color='b')
plt.plot(train_rewards, label='Train Reward', color='r')
plt.xlabel('Episode', fontsize=20)
plt.ylabel('Reward', fontsize=20)
plt.hlines(REWARD_THRESHOLD, 0, len(test_rewards), color='g')
