...
def preprocessing(X_train, y_train, X_valid, y_valid, history_length=10):
...
def train_model(X_train, y_train, X_valid, y_valid, batch_size, lr, model_dir="./models"):
    ...
    agent.save("./models/model_disc_new")
...
if __name__ == "__main__":
    ...
    train_model(X_train, y_train, X_valid, y_valid, batch_size=64, lr=0.01)
