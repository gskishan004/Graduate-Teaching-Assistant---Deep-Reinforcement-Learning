...
for epoch in range(epochs):
    ...
    # saving results
    with open(log_name+"loss.txt", "a+") as file:
        file.write(str(losses) + '\n')
        file.write(str(losses.mean())+'\n')
    with open(log_name+"train_score.txt", "a+") as file:
        file.write(str(train_scores) + '\n')
        file.write(str(train_scores.mean())+'\n')
    with open(log_name+"test_score.txt", "a+") as file:
